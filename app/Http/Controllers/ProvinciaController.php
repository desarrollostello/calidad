...
class ProvinciaController extends Controller
{
    ...
    {
        $this->middleware('permission:provincia.index');
        $this->middleware('permission:provincia.create');
        $this->middleware('permission:provincia.store');
        $this->middleware('permission:provincia.edit');
        $this->middleware('permission:provincia.update');
        $this->middleware('permission:provincia.delete');
